            ...
            <div class="items-center lg:flex">
              <div class="lg:w-1/2">
                ...
                <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                  This is a React / Firebase v9 project . I also use Tailwind
                  CSS for the front end . Project inspired by the House
                  Marketplace app . Project from the React Front To Back 2022
